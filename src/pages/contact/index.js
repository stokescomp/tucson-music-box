    ...
    return (
      <>
        ...
        <div className={contact.wordscontainer}>
            <h1 className={contact.title}>Contact Us!</h1><hr></hr>
        ...
        <div className={contact.form}>
            <form>
                <label className={contact.personalinfo} for='firstName'>First Name:</label><br></br>
                <input type='text' name='firstName'></input><br></br>
                <label className={contact.personalinfo} for='lastName'>Last Name:</label><br></br>
                <input type='text' name='LasttName'></input><br></br>
                <label className={contact.personalinfo} for='email'>Email:</label><br></br>
